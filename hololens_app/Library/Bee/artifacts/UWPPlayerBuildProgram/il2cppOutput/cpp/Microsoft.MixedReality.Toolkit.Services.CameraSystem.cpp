...
IL2CPP_EXTERN_C RuntimeField* U3CPrivateImplementationDetailsU3E_t0A13D8C06C7BBC92FFD2BDC1995B975B44C9C277____14FF3DFB16113535DA321A4416C6F1B52ACD09744A45FE321F822FDA863E5A4C_FieldInfo_var;
...
{
	__StaticArrayInitTypeSizeU3D138_t18BF26CB704E3E8E179F9DB38EFAD5EC7F7BB730 ___14FF3DFB16113535DA321A4416C6F1B52ACD09744A45FE321F822FDA863E5A4C;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR MonoScriptData_t59622A7E750094927C72B1A48199C3E3DCF9F1E1 UnitySourceGeneratedAssemblyMonoScriptTypes_v1_Get_m2419E9312942E82F11281A75B95B0A61249D63E7 (const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&U3CPrivateImplementationDetailsU3E_t0A13D8C06C7BBC92FFD2BDC1995B975B44C9C277____14FF3DFB16113535DA321A4416C6F1B52ACD09744A45FE321F822FDA863E5A4C_FieldInfo_var);
	...
	memset((&V_0), 0, sizeof(V_0));
	{
		...
		RuntimeFieldHandle_t6E4C45B6D2EA12FC99185805A7E77527899B25C5 L_2 = { reinterpret_cast<intptr_t> (U3CPrivateImplementationDetailsU3E_t0A13D8C06C7BBC92FFD2BDC1995B975B44C9C277____14FF3DFB16113535DA321A4416C6F1B52ACD09744A45FE321F822FDA863E5A4C_FieldInfo_var) };
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool MixedRealityCameraSystem_get_IsOpaque_m9F214F00F520CEBEC6C7251007E8502D42C634A1 (MixedRealityCameraSystem_t1280EF5F551F65DA92CEACC237C34D4CF208E09A* __this, const RuntimeMethod* method) 
{
	...
	{
		__this->___currentDisplayType = 0;
		RuntimeObject* L_0;
	...
	{
		__this->___currentDisplayType = 1;
		goto IL_0038;
	}
...
IL_0038:
	{
		int32_t L_6 = __this->___currentDisplayType;
...
IL_0055:
	{
		...
		bool L_13;
		L_13 = Type_op_Equality_m99930A0E44E420A685FABA60E60BA1CC5FA0EBDC(G_B6_0, (Type_t*)NULL, NULL);
		if (L_13)
		{
			goto IL_00cd;
		}
...
IL_00df:
	{
		bool L_37 = __this->___useFallbackBehavior;
		if (!L_37)
		{
			goto IL_0179;
		}
	}
	{
		...
		__this->___cameraOpaqueLastFrame = L_38;
		bool L_39;
...
IL_010c:
	{
		...
		MixedRealityPlayspace_set_Position_m7D30E4AE905CEC588A48631F70E6DBF30907A8F7(L_40, NULL);
		...
		MixedRealityPlayspace_set_Rotation_m5B31C93B855C6E1A343823A1F5259B59D9C9B185(L_41, NULL);
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_42;
		L_42 = CameraCache_get_Main_m08DDDB3EC260B690A997F10C0B85678322E20B6A(NULL);
		NullCheck(L_42);
		...
		bool L_46;
		L_46 = Vector3_op_Inequality_m9F170CDFBF1E490E559DA5D06D6547501A402BBF_inline(L_44, L_45, NULL);
		if (!L_46)
		{
			goto IL_0154;
		}
	}
	{
		...
		String_t* L_50;
		L_50 = String_Format_mA8DBB4C2516B9723C5A41E6CB1E2FAF4BBE96DD8(_stringLiteral4FF56F0DB79ED48F92A89FC9BCCE0794BDA6075F, L_49, NULL);
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		...
		{
			{
				...
				bool L_4 = __this->___cameraOpaqueLastFrame;
			...
			}
			{
				...
				__this->___cameraOpaqueLastFrame = L_5;
				bool L_6;
