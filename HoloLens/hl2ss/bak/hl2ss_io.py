...
def _create_wr_rm_vlc(
    filename, port, mode, divisor, profile, level, bitrate, options, user
):
    w = _writer()
    w.open(filename)
    w.put(_create_header(port, user))
    w.put(
        hl2ss._create_configuration_for_rm_vlc(
...
def _create_wr_rm_depth_ahat(
    filename, port, mode, divisor, profile_z, profile_ab, level, bitrate, options, user
):
    w = _writer()
    w.open(filename)
    w.put(_create_header(port, user))
    w.put(
        hl2ss._create_configuration_for_rm_depth_ahat(
...
def _create_wr_pv(
    ...
    w.put(_create_header(port, user))
    w.put(
        hl2ss._create_configuration_for_pv(
...
class wr_rm_vlc(hl2ss._context_manager):
    def __init__(
        self, filename, port, mode, divisor, profile, level, bitrate, options, user
    ):
...
class wr_rm_depth_ahat(hl2ss._context_manager):
    ...
    def open(self):
        self._wr = _create_wr_rm_depth_ahat(
            self.filename,
            self.port,
            self.mode,
            self.divisor,
...
class wr_rm_depth_longthrow(hl2ss._context_manager):
    ...
    def open(self):
        self._wr = _create_wr_rm_depth_longthrow(
            self.filename,
            self.port,
            self.mode,
            self.divisor,
...
class wr_microphone(hl2ss._context_manager):
    ...
    def open(self):
        self._wr = _create_wr_microphone(
            self.filename, self.port, self.profile, self.level, self.user
        )
...
def _create_wr_from_rx_rm_depth_longthrow(filename, rx, user):
    return wr_rm_depth_longthrow(
        filename, rx.port, rx.mode, rx.divisor, rx.png_filter, user
    )
...
class _reader:
    ...
    def get_configuration_for_rm_vlc(self):
        return (
            self.get_configuration_for_mode()
            + self.get_configuration_for_video_divisor()
            + self.get_configuration_for_video_encoding()
            + self.get_configuration_for_h26x_encoding()
        )
    ...
    def get_configuration_for_rm_depth_ahat(self):
        return (
            self.get_configuration_for_mode()
            + self.get_configuration_for_video_divisor()
            + self.get_configuration_for_depth_encoding()
            + self.get_configuration_for_video_encoding()
            + self.get_configuration_for_h26x_encoding()
        )
    ...
    def get_configuration_for_rm_depth_longthrow(self):
        return (
            self.get_configuration_for_mode()
            + self.get_configuration_for_video_divisor()
            + self.get_configuration_for_png_encoding()
        )
    ...
    def get_configuration_for_pv(self):
        return (
            self.get_configuration_for_mode()
            + self.get_configuration_for_video_format()
            + self.get_configuration_for_video_divisor()
            + self.get_configuration_for_video_encoding()
            + self.get_configuration_for_h26x_encoding()
        )
...
class _rd(hl2ss._context_manager):
    def __load_rm_vlc(self):
        (
            ...
            self.bitrate,
            self.options,
        ) = self._rd.get_configuration_for_rm_vlc()
    ...
    def __load_rm_depth_ahat(self):
        (
            ...
            self.bitrate,
            self.options,
        ) = self._rd.get_configuration_for_rm_depth_ahat()
        self._rd.begin(self.mode)
    ...
    def __load_rm_depth_longthrow(self):
        (
            ...
            self.divisor,
            self.png_filter,
        ) = self._rd.get_configuration_for_rm_depth_longthrow()
        self._rd.begin(self.mode)
    ...
    def __load_pv(self):
        (
            ...
            self.bitrate,
            self.options,
        ) = self._rd.get_configuration_for_pv()
        self._rd.begin(self.mode)
    ...
    def open(self):
        self._rd, self.magic, self.port, self.user = _create_rd(
            self.filename, self.chunk
        )
        self.__build()
        self.__load()
...
class _rd_decoded(_rd):
    ...
    __method_table = {
        ...
        hl2ss.StreamPort.RM_DEPTH_AHAT: (
            __set_codec_rm_depth_ahat,
            __create_codec_rm_depth_ahat,
            __decode_rm_depth_ahat,
        ),
        hl2ss.StreamPort.RM_DEPTH_LONGTHROW: (
            __set_codec_rm_depth_longthrow,
            __create_codec_rm_depth_longthrow,
            __decode_rm_depth_longthrow,
        ),
        hl2ss.StreamPort.RM_IMU_ACCELEROMETER: (
            __set_codec_rm_imu,
            __create_codec_rm_imu,
            __decode_rm_imu,
        ),
        ...
        hl2ss.StreamPort.MICROPHONE: (
            __set_codec_microphone,
            __create_codec_microphone,
            __decode_microphone,
        ),
...
class sequencer:
    ...
    def get_next_packet(self, timestamp):
        ...
        return (
            self._l
            if ((timestamp - self._l.timestamp) < (self._r.timestamp - timestamp))
            else self._r
        )
